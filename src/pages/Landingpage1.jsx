    ...
    <section className="relative min-h-[85vh] flex flex-col items-center justify-center overflow-hidden border-b border-white/10 pt-20">
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto flex flex-col items-center">
        ...
        <div className="flex gap-4 flex-wrap justify-center">
          <button onClick={() => navigate('/landing')} className="px-8 py-4 rounded-xl bg-cyan-500 hover:bg-cyan-400 text-slate-900 font-bold transition-all shadow-[0_0_20px_rgba(34,211,238,0.3)] hover:shadow-[0_0_30px_rgba(34,211,238,0.5)]">
            Login
          </button>
    ...
    <div className="min-h-screen bg-[#020617] text-white selection:bg-cyan-500/30">
      ...
      <nav className="fixed top-0 w-full z-50 border-b border-white/10 bg-[#020617]/50 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <button onClick={() => navigate('/landing')} className="px-5 py-2.5 rounded-lg border border-cyan-500/30 text-cyan-400 font-medium hover:bg-cyan-500/10 hover:shadow-[0_0_20px_rgba(34,211,238,0.2)] transition-all text-sm">
            Login
          </button>
        </div>
      </nav>
